...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        # Columnspan means span 2 column from column 0, which span to column 1
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)

        true_image = PhotoImage(file="11. Quizzler app/images/true.png")
        self.button_true = Button(image=true_image, highlightthickness=0, command=self.press_true_button)
        self.button_true.grid(row=2, column=0)

        false_image = PhotoImage(file="11. Quizzler app/images/false.png")
